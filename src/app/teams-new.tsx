...
const TeamsPage = () => {
  ...
  const [generationMode, setGenerationMode] = useState<TeamGenerationMode>("numTeams");
  ...
  const availablePlayers = initialPlayers.filter(player => 
                ...
                <div className="space-y-2">
                  ...
                  >
                    <div className="text-left">
                      ...
                      <div className="text-xs opacity-70">Automatically distribute players</div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="text-left">
                      ...
                      <div className="text-xs opacity-70">Create teams manually</div>
                    </div>
                  </button>
                  ...
                  >
                    <div className="text-left">
                      ...
                      <div className="text-xs opacity-70">
                        {selectedTemplate ? `Selected: ${selectedTemplate.name}` : "Choose saved template"}
                      </div>
                    </div>
                  </button>
                </div>
          ...
          <div className="lg:col-span-2">
            ...
            {teams.length === 0 && (
              <div className="bg-card border border-border rounded-xl p-12 text-center">
                ...
                <h3 className="text-lg font-semibold font-heading mb-2">No Teams Created</h3>
